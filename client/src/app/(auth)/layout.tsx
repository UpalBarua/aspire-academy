  ...
  return (
    <section className="mx-auto min-h-screen max-w-7xl lg:relative">
      <div
        ...
        lg:fixed lg:left-0 lg:top-0 lg:min-w-[28rem] lg:items-start lg:px-10 lg:shadow-2xl"
      >
        <Image
          src="/images/logo.png"
          alt="au logo"
      ...
      <div
        ...
        h-full w-[calc(100%-28rem)] bg-[url('/images/auth-banner.jpg')] bg-cover bg-center lg:block"
      >
