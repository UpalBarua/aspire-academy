  ...
  return (
    <section className="mx-auto min-h-screen max-w-7xl lg:relative">
      <div
        ...
        lg:fixed lg:left-0 lg:top-0 lg:items-start lg:px-10"
      >
        <Image
          src="/images/logo.png"
          alt="au logo"
      ...
      <div
        className="fixed left-[24rem] top-0 hidden 
        h-full w-[calc(100%-24rem)] bg-[url('/images/auth-img.jpg')] bg-cover bg-center lg:block"
      >
